...
Platform Engineer (SRE-minded) with 5+ years automating software delivery and scaling cloud platforms. Kubernetes CKAD • CKA • CKS. I ship in Go (Golang) and Python.
...
![FluxCD](https://img.shields.io/badge/-FluxCD-FFFFFF?logo=flux&logoColor=0F1689&style=flat)
![ArgoCD](https://img.shields.io/badge/-ArgoCD-FE4D5A?logo=argo&logoColor=white&style=flat)
...
![SLOs](https://img.shields.io/badge/-SLOs-4B4B4B?style=flat)
